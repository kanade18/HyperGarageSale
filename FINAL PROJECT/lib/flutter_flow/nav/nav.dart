...
class AppStateNotifier extends ChangeNotifier {
  GarageSaleFirebaseUser? initialUser;
  GarageSaleFirebaseUser? user;
  ...
  void update(GarageSaleFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? LoginPageWidget() : HomepageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'BrowseProduct',
              path: 'browseProduct',
              builder: (context, params) => BrowseProductWidget(),
            ),
            FFRoute(
              name: 'AddPostPage',
              path: 'addPostPage',
